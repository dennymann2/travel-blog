export function IntroSection() {
  return (
    <section className="relative bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-orange-500/10 blur-3xl translate-x-1/2 translate-y-1/2" />
      </div>
      ...
      <div className="relative mx-auto max-w-5xl px-6 space-y-16">
        ...
        {/* Premium Stats */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-t border-b border-slate-700/50">
          <div className="space-y-3 group cursor-default hover:scale-105 transition-transform duration-300">
            <div className="text-5xl md:text-6xl font-black bg-gradient-to-r from-amber-300 to-orange-400 bg-clip-text text-transparent group-hover:drop-shadow-lg transition">4</div>
            <p className="text-xs md:text-sm text-slate-400 font-semibold uppercase tracking-wider group-hover:text-slate-300 transition">
              Kontinente
            </p>
          </div>
          <div className="space-y-3 group cursor-default hover:scale-105 transition-transform duration-300">
            <div className="text-5xl md:text-6xl font-black bg-gradient-to-r from-amber-300 to-orange-400 bg-clip-text text-transparent group-hover:drop-shadow-lg transition">65+</div>
            <p className="text-xs md:text-sm text-slate-400 font-semibold uppercase tracking-wider group-hover:text-slate-300 transition">
              Tage
            </p>
          </div>
          <div className="space-y-3 group cursor-default hover:scale-105 transition-transform duration-300">
            <div className="text-5xl md:text-6xl font-black bg-gradient-to-r from-amber-300 to-orange-400 bg-clip-text text-transparent group-hover:drop-shadow-lg transition">12</div>
            <p className="text-xs md:text-sm text-slate-400 font-semibold uppercase tracking-wider group-hover:text-slate-300 transition">
              Geschichten
            </p>
          </div>
          <div className="space-y-2">
            <div className="text-4xl md:text-5xl font-black text-amber-500">∞</div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="space-y-3 p-6 rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/30 hover:border-amber-400/50 transition-colors backdrop-blur-sm">
